...
<!-- navbar -->
    <div class="navbarr">
        ...
        <ul>
            ...
            <li><a href="viewTrainingdetails.php">Schedule</a></li>
                    ...
                    $sql = 'SELECT * FROM registered_students_athletes';
